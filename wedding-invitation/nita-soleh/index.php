<?php
include('../nita-soleh/koneksi.php');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
	<meta name="description" content="Undangan pernikahan Nita dan Soleh. Selasa, 19 Oktober 2021.">
	<meta property="og:title" content="Undangan pernikahan Nita dan Soleh. Selasa, 19 Oktober 2021." />
	<meta property="og:url" content="https://nita-soleh.digital-invitation.com/" />
	<meta property="og:description" content="Undangan pernikahan Nita dan Soleh. Selasa, 19 Oktober 2021.">
	<meta property="og:image" content="https://nita-soleh.digital-invitation.com/1.bp.blogspot.com/-FuprKxe6I3I/X3waINlnqnI/AAAAAAAAFzo/DF1N99KVgt8ZjEiaNubMyRjz17nxGNAxQCLcBGAsYHQ/s16000/AZ--531.jpg">
        ...
        $('#welcome-gate').addClass('move-gate');
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p style="text-align: center;">19 Oktober 2021</p></div>
			...
			</div> <!-- .et_pb_section --><div class="et_pb_section et_pb_section_2 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider" style="background-color: #C89F84!important;">
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner">
					<h1>Nita Irfanita Sapithry</h1>
                	<p><strong>Putri dari</strong><br> Bpk. Zulkifli Sudrajat<br> &amp; Ibu Kusmiati</p>
				</div>
			</div> <!-- .et_pb_text -->
				...
				<div class="et_pb_text_inner">
					<h1>Solehudin</h1>
                    <p><strong>Putra dari</strong><br> Bpk. Komar<br> &amp; Ibu Imas</p>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
				...
				<div class="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp="1634608800">
			...
			</div> <!-- .et_pb_row --><div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #C89F84!important;">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							<p>Selasa, 19 Oktober 2021<br> 09.00 s/d 11.00 WIB<br> <strong>Kediaman Mempelai Wanita</strong><br> Dusun Cipariuk RT.01/RW0.1 Desa Neglasari Kecamatan Banjar,<br> Kota Banjar</p>
						</div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
				...
				<a class="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" href="https://goo.gl/maps/d276u5JLC9tPTqiMA" target="_blank" style="background-color: #C89F84!important;">Google Maps</a>
			</div>
			</div> <!-- .et_pb_column -->
	...
	<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
					...
					<div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #C89F84!important;">
			...
			<div class="et_pb_section et_pb_section_5 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider" style="background-color: #C89F84!important;">
						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
									<?php
								      ...
								      $query = "SELECT * FROM tb_nita ORDER BY id ASC";
			...
			<div id="et_pb_contact_form_0" class="et_pb_module et_pb_contact_form_0 et_pb_contact_form_container clearfix" >
				...
				<div class="et_pb_contact">
					<form method="post" action="../nita-soleh/tambah_pesan.php">
						...
						<div class="et_contact_bottom_container">
							...
							<button type="submit" class="et_pb_contact_submit et_pb_button" style="background-color: #C89F84">Kirim</button>
						</div>
			 ...
			 <!-- .et_pb_row --><div class="et_pb_row et_pb_row_8">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p><br>Nita &amp; Soleh</p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			</div> <!-- .et_pb_column -->
